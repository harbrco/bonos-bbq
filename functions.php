...
function html5blank_header_scripts()
{
    if (!is_admin()) {
        ...
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/min/scripts-min.js', array(), '1.0.0', true); // Custom scripts
...
// {
//     register_taxonomy_for_object_type('category', 'locations-list'); // Register Taxonomies for Category
//     register_taxonomy_for_object_type('post_tag', 'locations-list');
//     register_post_type('locations-list', // Register Custom Post Type
//         array(
//         'labels' => array(
